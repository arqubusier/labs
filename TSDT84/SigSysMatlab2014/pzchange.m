...
% (c) Lasse Alfredsson, januari 1995 och senare

% OBS!! PZCHANGE needs the following functions: PZMENU, PZSPPLOT, and GINPUT2

global TRFM THEFIG MENUFLG	% TRFM is the name of the transform that will be 
global REDX REDO TEXT1 NORMMODE	% created/changed. THEFIG is the corrent figure.
...
x=inf;  			% present x-coordinate
y=inf;  			% present y-coordinate
